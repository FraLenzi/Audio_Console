...
--Date        : Sun May 15 20:58:38 2022
--Host        : FrancescoLenzi running 64-bit major release  (build 9200)
--Command     : generate_target audio_console_wrapper.bd
--Design      : audio_console_wrapper
...
entity audio_console_wrapper is
  port (
...
end audio_console_wrapper;

architecture STRUCTURE of audio_console_wrapper is
  component audio_console is
  port (
    sys_clock : in STD_LOGIC;
    reset : in STD_LOGIC;
...
audio_console_i: component audio_console
     port map (
